...
public class ProblemSolvingTemplate {
    ...
    *  -> If you don't understand the problem --> Ask for more !!
    * 
    ...
    *  
    *  4) Ask for hints !! (Ask good questions !! don't ask bad questions)
    *  - Put it nicely
    *  - Never leave a big silence between you and interviewer
    *  = Sorry, I could not make it? Can I have another question?
    *  
    *  Tip: Sorry, I don't know the approach. But making a note of it !!
    ...
    *  
    *  - Confirm it working for each test data
    *  
